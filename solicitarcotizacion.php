			...
			<div class="contact_form">
				...
				<div class="contact_form_container">
					<form action="#" id="contact_form" class="contact_form">
						<input type="number" id="contact_input" class="contact_input" placeholder="Número de identificación" required="required">
						<button class="contact_button" id="contact_button">Verificar</button>
						<button class="contact_button2" id="contact_button2">Registrarse</button>
					</form>
				</div>
			</div>
		</div>
